...
class NonUniformExplicit : public ExplicitBase<NonUniformExplicit<REAL>, REAL> {
  public:
    ...
    /**
     * get the spacing at (i, j) ito r with either forward, backward, or central differences
     */
    ...
    /**
     * get the spacing at (i, j) ito z with either forward, backward, or central differences
     */
    ...
    REAL central_finite_r(Field<REAL, 2>& f, int i, int j){
      REAL C1, C2, C3;
      C1 = this->get_dr(i, j, -1) / (this->get_dr(i, j, 0) * this->get_dr(i, j, 1));
      C2 = (this->get_dr(i, j, 1) - this->get_dr(i, j, -1)) / (this->get_dr(i, j, -1) * this->get_dr(i, j, 1));
      C3 = -1 * this->get_dr(i, j, 1) / (this->get_dr(i, j, 0) * this->get_dr(i, j, -1));
    ...
    REAL central_finite_z(Field<REAL, 2>& f, int i, int j){
      REAL C1, C2, C3;
      C1 = this->get_dz(i, j, -1) / (this->get_dz(i, j, 0) * this->get_dz(i, j, 1));
      C2 = (this->get_dz(i, j, 1) - this->get_dz(i, j, -1)) / (this->get_dz(i, j, -1) * this->get_dz(i, j, 1));
      C3 = -1 * this->get_dz(i, j, 1) / (this->get_dz(i, j, 0) * this->get_dz(i, j, -1));
