...
function(CHECK_VERSION_COMPATIBILITY PACKAGE_CONFIG VERSION RESULT)
  # checks to see if a given version number is compatible with a given package,
  # using the packages *ConfigVersion.cmake file.

  set(${RESULT}
      "CONFIGVERSION-NOTFOUND"
      PARENT_SCOPE)

  string(REGEX REPLACE "Config\.cmake$" "ConfigVersion.cmake"
                       PACKAGE_CONFIGVERSION ${PACKAGE_CONFIG})
