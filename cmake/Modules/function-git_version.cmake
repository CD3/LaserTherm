...
function(GIT_VERSION VAR_PREFIX)
  ...
  if(GIT_FOUND)
    ...
    if(${IsGitRepo} EQUAL 0)
      if("${GIT_COMMIT_ID}" STREQUAL "")
        execute_process(
          COMMAND ${GIT_EXECUTABLE} rev-parse --sq HEAD
          WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
      ...
      if("${GIT_COMMIT_AUTHOR}" STREQUAL "")
        execute_process(
          COMMAND ${GIT_EXECUTABLE} log -n1 --pretty="%an" HEAD
          WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
      ...
      if("${GIT_COMMIT_DATE}" STREQUAL "")
        execute_process(
          COMMAND ${GIT_EXECUTABLE} log -n1 --pretty="%aD" HEAD
          WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
      ...
      message(
        WARNING "Source directory is not a git repo. Checking for version.txt")
  ...
  # remove quotes, backslashes, and new lines these cause problems when trying
  # to embed version numbers into source files.
  foreach(item ${GIT_INFO})
  ...
  set(${VAR_PREFIX}_VERSION
      ${VERSION}
      PARENT_SCOPE)
  set(${VAR_PREFIX}_VERSION_MAJOR
      ${VERSION_MAJOR}
      PARENT_SCOPE)
  set(${VAR_PREFIX}_VERSION_MINOR
      ${VERSION_MINOR}
      PARENT_SCOPE)
  set(${VAR_PREFIX}_VERSION_PATCH
      ${VERSION_PATCH}
      PARENT_SCOPE)
