...
TEST_CASE("Waveform Mixins")
{
  ...
  {
    Waveforms::AddExposureDuration< Waveforms::AddStartTime< Waveforms::Base<double> > > exp;
  ...
  SECTION("CW Waveform isOn Check")
  {
    SECTION("with start time and exposure duration")
    {
      ...
      Waveforms::AddStartTime<
      Waveforms::Base<double> > > > exp;
  ...
  SECTION("Regular Pulse Train Waveform isOn Check")
  {
    ...
    SECTION("with pulse duration and PRF, but no start time or exposure duration")
    {
      Waveforms::AddIsOnCalc<
      Waveforms::AddPulseDuration<
      Waveforms::AddPulseRepititionFrequency<
    ...
    SECTION("with pulse duration, PRF, and exposure duration, but no start time")
    {
    }
    SECTION("with pulse duration, PRF, start time, and exposure duration, but no start time")
    {
    }
  }
