...
TEST_CASE("Linear Absorption Emitter")
{
  ...
  SECTION("CW Exposure")
  {
    Emitters::Basic< HeatSources::_1D::BeersLaw<double>, Waveforms::ContinuousWave<double> > emitter(11);
  ...
  SECTION("Multi-Pulse Exposure")
  {
    ...
    Emitters::Basic< HeatSources::_1D::BeersLaw<double>, Waveforms::RegularPulseTrain<double> > emitter(11);
